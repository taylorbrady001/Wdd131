...
console.log("Simple Sort (default):", simpleSort);
...
const anotherSort = simpleList.sort(descendingCompare);
console.log("Descending Sort:", anotherSort);

// -----------------------------
// Activity 2: Filter strings
// -----------------------------
...
// -----------------------------
// Activity 3: Filter + sort objects
// -----------------------------
...
console.log("Search Hikes: 'yellowstone'", searchHikes(hikes, "yellowstone"));
console.log("Search Hikes: 'moderate'", searchHikes(hikes, "moderate"));
console.log("Search Hikes: 'al'", searchHikes(hikes, "al"));
